  ...
  <div class="change-user-info-container">
     <form action="" method="post" @submit.prevent='changeInfo'>
            ...
            <span v-for="book in userInfo.have">《{{ book.bookName }}》<i @click="delateBook" class="fa fa-times-circle" aria-hidden="true" name="mybooktag"></i></span>
                 ...
                 <form action="http://192.168.155.1:8080/example_mysql/rest/upload/image" method="post"
                 enctype="multipart/form-data">
                <div class="userimg">
                <input type="hidden" v-model="userId" name="userId">
                      <label for="">修改头像</label>
                <img :src="userInfo.coverImg">
                <input type="file" accept="image/png" @change="uploadImg" id='filebtn'>
  ...
  export default {
    ...
    route :{
            data () {
               ...
               var self=this;
               $.ajax({
                   url:'http://192.168.155.1:8080/Test/userinfo',
                   type:'post',
                   data:{
                   ...
                   success:function(data){
                        ...
                        console.log(data);
                        self.userInfo.coverImg='data:image/png;base64,'+self.userInfo.coverImg;
                        //localStorage.userImgUrl=self.userInfo.coverImg;
                   },
                   error:function(){
       ...
       jdugeLogin:function(){
             ...
             createImage:function(file){
                    ...
                    reader.onload = function (e) {
                         ...
                         vm.userInfo.coverImg= e.target.result;
                      };
             ...
             changeInfo:function(){
              ...
              if(this.validate()){
                    $.ajax({
                      url:'http://192.168.155.1:8080/Test/modifyinfo',
                      type:'post',
                      data:{
